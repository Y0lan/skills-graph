...
export function mergeExtractions(existing: ExtractedFields, incoming: ExtractedFields, lockedFieldNames: Set<string>, strategy: MergeStrategy): MergeResult {
...
export function applyRecruiterDecisions(existing: ExtractedFields, incoming: ExtractedFields, acceptedFieldNames: Set<string>, lockedFieldNames: Set<string>): ExtractedFields {
