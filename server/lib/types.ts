...
export type CandidatureStatut = 'postule' | 'preselectionne' | 'skill_radar_envoye' | 'skill_radar_complete' | 'entretien_1' | 'aboro' | 'entretien_2' | 'proposition' | 'embauche' | 'refuse';
...
export function safeJsonParse<T>(json: unknown, fallback: T, context?: string): T {
    if (json == null)
        return fallback;
