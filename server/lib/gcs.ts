...
export const DOCUMENTS_BUCKET = process.env.DOCUMENTS_BUCKET || 'skill-radar-litestream-premier'
export const DOCUMENTS_PREFIX = process.env.DOCUMENTS_PREFIX || 'dev/documents'
...
export async function uploadToGcs(
  ...
  return `gs://${DOCUMENTS_BUCKET}/${gcsPath}`
}
 ...
 */
function parseGcsPath(storedPath: string): { bucket: string; filePath: string } {
